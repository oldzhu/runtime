...
if(CLR_CMAKE_HOST_OS STREQUAL Linux)
    ...
    if(CLR_CROSS_COMPONENTS_BUILD)
        ...
        elseif(CMAKE_SYSTEM_PROCESSOR STREQUAL riscv32)
            set(CLR_CMAKE_HOST_UNIX_RISCV32 1)
...
elseif(CLR_CMAKE_HOST_UNIX_RISCV32)
    set(CLR_CMAKE_HOST_ARCH_RISCV32 1)
    set(CLR_CMAKE_HOST_ARCH "riscv32")
...
message(status " ${CLR_CMAKE_TARGET_ARCH}")
message(status " ${CMAKE_SYSTEM_PROCESSOR}")
message(status " ${CLR_CMAKE_HOST_ARCH}")
# Set target architecture variables
if (CLR_CMAKE_TARGET_ARCH STREQUAL x64)
  ...
  elseif(CLR_CMAKE_TARGET_ARCH STREQUAL riscv32)
    set(CLR_CMAKE_TARGET_ARCH_RISCV32 1)
