...
elseif(TARGET_ARCH_NAME MATCHES "^(armel|arm|arm64|loongarch64|s390x|x86|riscv32|riscv64)$" OR FREEBSD OR ILLUMOS)
  set_cache_value(FILE_OPS_CHECK_FERROR_OF_PREVIOUS_CALL_EXITCODE 1)
  ...
  message(FATAL_ERROR "Arch is ${TARGET_ARCH_NAME}. Only riscv32, riscv64, armel, arm, arm64, loongarch64, s390x and x86 are supported!")
endif()
