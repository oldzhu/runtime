...
while [[ $# > 0 ]]; do
  ...
  case "$opt" in
     ...
     -arch|-a)
      ...
      case "$passedArch" in
        x64|x86|arm|armv6|armel|arm64|loongarch64|riscv64|s390x|ppc64le|wasm|riscv32)
          arch=$passedArch
          ;;
        *)
          echo "Unsupported target architecture '$2'."
          echo "The allowed values are x86, x64, arm, armv6, armel, arm64, loongarch64, riscv64, s390x, ppc64le and wasm, riscv32."
          exit 1
          ;;
      esac
      shift 2
